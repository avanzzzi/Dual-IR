...
DefaultGroupName=Dual-IR
OutputBaseFilename="Dual-IR-Win-##APPVERSION##"
OutputDir=.
LicenseFile=../../LICENSE.txt
SetupIconFile=../../resources/Dual-IR.ico
...
[Files]
Source: "../../bin/Win64/Dual-IR.vst3"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/Dual-IR.vst3"; DestDir: "{code:GetDir|VST3_32}"; Components: VST3_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/Dual-IR.exe"; DestDir: "{code:GetDir|STANDALONE_64}"; Components: STANDALONE_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/Dual-IR.exe"; DestDir: "{code:GetDir|STANDALONE_32}"; Components: STANDALONE_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../resources/Dual-IR.ico"; Components: STANDALONE_64; DestDir: "{pf64}\GuitarML"
Source: "../../resources/Dual-IR.ico"; Components: STANDALONE_32; DestDir: "{pf32}\GuitarML"

[Icons]
Name: "{userdesktop}\Dual-IR"; Filename: "{pf64}\GuitarML\Dual-IR.exe"; \
    IconFilename: "{pf64}\GuitarML\dual-ir.ico"; Tasks: desktopicon;
Name: "{userdesktop}\Dual-IR32"; Filename: "{pf32}\GuitarML\Dual-IR.exe"; \
    IconFilename: "{pf32}\GuitarML\dual-ir.ico"; Tasks: desktopicon;
